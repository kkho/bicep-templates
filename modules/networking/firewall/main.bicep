...
var firewallPublicIpName = '${resourceName}-pip-afw'
var firewallManagementPublicIpName = '${resourceName}-pip-mgmt-afw'
...
resource fw_pip 'Microsoft.Network/publicIPAddresses@2024-10-01' = {
...
resource fwManagementIp_pip 'Microsoft.Network/publicIPAddresses@2024-10-01' = if (fwSku == 'Basic') {
...
var fw_name = '${resourceName}-afw'
resource fw 'Microsoft.Network/azureFirewalls@2024-10-01' = {
  name: fw_name
  location: location
  zones: !empty(availabilityZones) ? availabilityZones : []
  properties: {
...
resource fwPolicy 'Microsoft.Network/firewallPolicies@2024-10-01' = {
  name: '${resourceName}-afwp'
  location: location
  properties: {
    sku: {
      tier: fwSku
...
resource fwpRules 'Microsoft.Network/firewallPolicies/ruleCollectionGroups@2024-10-01' = {
  parent: fwPolicy
